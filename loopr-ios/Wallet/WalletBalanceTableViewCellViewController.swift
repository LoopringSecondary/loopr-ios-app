...
class WalletBalanceTableViewCellViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        receiveButton.titleLabel?.font = FontConfigManager.shared.getLabelENFont(size: 14.0)
        ...
        sendButton.titleLabel?.font = FontConfigManager.shared.getLabelENFont(size: 14.0)
